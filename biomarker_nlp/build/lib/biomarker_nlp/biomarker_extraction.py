...
def targeted_therapy_url(url):
  ...
  Use lxml library to parse the URL link and xpath to find the therapy's link in "what-targeted-therapies-have-been-approved-for-specific-types-of-cancer" section.
  ...
  -------
  list
      Return a list of targeted therapies' url link.
...
def targeted_therapy_name(url):
  ...
  Use lxml library to parse the URL link and xpath to find the therapy's name from the parsed tree structure.
